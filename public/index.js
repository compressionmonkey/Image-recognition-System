document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        ...
        if (addPhotoBtn) {
            console.log('Found addPhotoBtn, adding click listener');
            ...
            console.log('addPhotoBtn not found');
        }

        if (addCashBtn) {
            console.log('Found addCashBtn, adding click listener');
            ...
            console.log('addCashBtn not found');
        }
    }
    ...
    // Update validateLogin to setup event listeners after login
    ...
    // Make validateLogin available globally
    ...
    const addPhotoBtn = document.getElementById('addPhotoBtn');
    console.log('addPhotoBtn element:', addPhotoBtn);
    if (addPhotoBtn) {
        console.log('Adding click listener to addPhotoBtn');
        addPhotoBtn.addEventListener('click', showPhotoOptions);
    }
    
    const addCashBtn = document.getElementById('addCashBtn');
    console.log('addCashBtn element:', addCashBtn);
    if (addCashBtn) {
        console.log('Adding click listener to addCashBtn');
        addCashBtn.addEventListener('click', showManualEntryModal);
    }
    ...
    function showPhotoOptions() {
        ...
        if (modal) {
            ...
            console.log('Showing photo options modal');
        } else {
            console.error('photoOptionsModal not found');
        }
    };

    function showManualEntryModal() {
        console.log('showManualEntryModal called');
        ...
        if (modal) {
            ...
            console.error('manualEntryModal not found');
        }
    };
    ...
    function showFullImage(image, index, total) {
        ...
        viewer.innerHTML = `
            <div class="viewer-content">
                ...
                <img src="${image.thumbnailUrl}" alt="Receipt ${index + 1}" class="preview-image">
                <div class="controls">
                    ${index > 0 ? '<button class="prev">Previous</button>' : ''}
                    ${index < total - 1 ? '<button class="next">Next</button>' : ''}
                    <button class="download">Download (${image.size})</button>
                </div>
                <div class="info">
                ...
                try {
                    ...
                    if (result.phoneDetected) {
                        ...
                        if (qualityMetrics.isStable && 
                            ...
                            qualityMetrics.confidence > 0.8 && !isCapturing) {
                            // Set capturing flag
                            isCapturing = true;
